...
const FooterPage = {
    ...
    help: {
        h2: "Помощь",
        description: `Общее представление об интерфейсе: для водителей и гидов, путешественников и автопарков.`,
            ...
            data: [
                ...
                [
                    { 
                        ...
                        text: 'Оплата происходит с водителем наличными в местной валюте,\n после завершения поездки.',
                        src: [{url:""}],
                        srcMobail:[{url:""}]
                    },
