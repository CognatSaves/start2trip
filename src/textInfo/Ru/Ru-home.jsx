const home = {
    ...
    home:{
        ...
        homeBottomNewText:{
            ...
            p:[
            "Укажите направление и дату в планировщике маршрутов, и выберите водителя.",
        ...
        renderArray:{
            first:{
                ...
                text:"Готовые маршруты для самостоятельных путешествий."
            },
            second:{
                title:"Туры",
                text:"Туры от местных гидов"
            },
            third:{
                title:"Гиды",
