const agencyProfile = {
    ...
    agencyProfileAffiliateProgramm:{
        ...
        affiliateProgramsDescription: "ააგეთ თქვენი წარმატებული ბიზნესი და მიიღეთ პასიური შემოსავალი სისტემის კომისიისაგან ყოველი გამგზავრებიდან 20%-ის ოდენობით. გაუგზავნეთ მოსაწვევები თქვენს ნაცნობ ტურისტებს პირველ მოგზაურობაზე 10%-იანი ფასდაკლებით. ამისათვის დააწკაპუნეთ ღილაკს „მეგობრის მოწვევა“ ან გააგზავნეთ შვილობილი ბმული. დაწერეთ სტატიები ჩვენს შესახებ, გაუკეთეთ კომენტარი სოციალურ ქსელებში ბლოგებსა და ფორუმებზე და მიიღეთ შემოსავალი. მთელი ცხოვრება. გადახდა ხდება ყოველკვირეულად საბანკო ბარათზე",
        affiliateLinks: {
