            ...
            <nav className={this.state.burgerMenu ? "burgerMenu burgerMenu-active" : "burgerMenu"}>
              <div className="burgerMenuBg">
                ...
                <div className="burgerMenuBottom">
                  <DropDownMenu
                    value={this.state.currencyValueActive}
                    anchorOrigin={{ vertical: 'bottom', horizontal: 'left', }}
                    className="dropdownClass burgerMenuBottomText  pl-1"
                  ...
                  >
                    <MenuItem value="Валюта" disabled={true} primaryText="Валюта" />
                    {this.state.activeCurrency.map((element, index) =>
                      <MenuItem value={element} ><span className="burgerMenuBottomText">{element}</span></MenuItem>
                    )}
                  </DropDownMenu>
                  <DropDownMenu
                    value={this.state.languageValueActive}
                    anchorOrigin={{ vertical: 'bottom', horizontal: 'left', }}
                    className="dropdownClass burgerMenuBottomText pl-1"
                    menuStyle={{ maxHeight: "150px" }}
                    onChange={this.handleChange}
                    ...
                    id="basicInfoLanguage"
                  >
                    <MenuItem value="Язык" disabled={true} primaryText="Язык" />
                    {this.state.languageValues.map((element, index) =>
                      <MenuItem value={element.value}> <img src={element.src} alt={element.value} className="mb-1" width="20px" height="15px" /><span className="burgerMenuBottomText">{element.value}</span></MenuItem>
                    )}
                  </DropDownMenu>
                  {/* <DropDownMenu
                                    ...
                                    id="basicInfoLanguage"
                                >
                                    <MenuItem value="Страна" disabled={true} primaryText="Страна" />
