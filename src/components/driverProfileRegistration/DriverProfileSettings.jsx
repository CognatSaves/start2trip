            ...
            <div className="driverProfilesettingsBody pb-1">
                ...
                <div className="driverProfileSettingsContent d-flex flex-column col-xl-9 col-lg-9 col-md-9 col-sm-11 col-11">
                    <form onSabmit="" id="profileSettings" >
                        <div className="d-xl-flex d-lg-flex d-md-flex d-sm-none d-none flex-xl-row flex-lg-row flex-md-row flex-sm-column flex-column align-items-xl-center align-items-lg-center align-items-md-center align-items-sm-start align-items-start">
                            <label htmlFor="sittingsEmail" className="d-xl-block d-lg-block d-md-block d-sm-none d-none col-xl-2 col-lg-2 col-md-2 col-sm-11 col-11 ">Email:</label>
                            <input id="sittingsEmail" className="d-xl-block d-lg-block d-md-block d-sm-none d-none col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" />
                        </div>
                        <TextField
                        ...
                        <div className="d-flex flex-xl-row flex-lg-row flex-md-row flex-sm-column flex-column align-items-xl-center align-items-lg-center align-items-md-center align-items-sm-start align-items-start ">
                            ...
                            // errorText="This field is required"
                            />
                            <input id="sittingsPhoneNumber" className="d-xl-block d-lg-block d-md-block d-sm-none d-none col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12 " type="tel" />
                        </div>
                        <div className="d-flex flex-xl-row flex-lg-row flex-md-row flex-sm-column flex-column align-items-center py-3">
                            <label className="col-2 pr-0" />
