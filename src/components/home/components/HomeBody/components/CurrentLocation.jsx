...
//let tempTravelLength=-100;
//let tempTravelTime=-222;
...
export class CurrentLocation extends React.Component {
  ...
  componentWillUnmount(){
    ...
    this.props.setLengthTime(tempFuck,this.state.travelTime);
  }*/
  componentWillUnmount(){
    /*let length = tempTravelLength;
    length=Math.ceil(length/1000);
    let lengthString = length;
    this.props.setLengthTime(lengthString,tempTravelTime);*/
  }
  loadMap() {
    console.log("loadMap");
