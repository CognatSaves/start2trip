...
class AccountFirstEnterModalClass extends React.Component {
    constructor(props){
        super(props);
        this.state = {
...
const AccountFirstEnterModal = connect(
    (state) => ({
        storeState: state.AppReduser,
        globalReduser: state.GlobalReduser,
    }),
)(AccountFirstEnterModalClass);

export default AccountFirstEnterModalClass;