                    ...
                    <div className="peopleMenu_element">
                        <div className="peopleMenu_element_part">
                            ...
                            <div className="element_part_valueBlock">
                                <button className="valueBlock_button minus" disabled={peopleDisabledMinus} onClick={() => this.props.changePersonsNumber(0, -1)}>&#8211;</button>
                        ...
                        <div className="peopleMenu_element_part">
                            ...
                            <div className="element_part_valueBlock">
                                <button className="valueBlock_button minus" disabled={childrenDisabledMinus} onClick={() => this.props.changePersonsNumber(1, -1)}>&#8211;</button>
