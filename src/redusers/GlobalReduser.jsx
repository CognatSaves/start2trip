...
const initialState = {
    ...
    */
    createDateTimeString(start, isOnlyDayString){
        ...
        let month = date.getMonth()+1; let day = date.getDate(); let hours = date.getHours(); let minutes = date.getMinutes();
        let res = date.getFullYear()+"-"+(month>=10 ? month : '0'+month)+"-"+(day>=10 ? day : '0'+day)+
